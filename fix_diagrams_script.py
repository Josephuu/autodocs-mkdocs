#!/usr/bin/env python3
# Crear script de diagramas sin saltos de línea Windows
...
with open('/workspace/generate-diagrams.sh', 'w', newline='\n') as f:
    f.write(script)

import os
os.chmod('/workspace/generate-diagrams.sh', 0o755)
print('✅ Script de diagramas recreado')
